...
> File này dành cho các coding agent đọc chuẩn AGENTS.md (Codex, Cursor, Antigravity, GitHub Copilot, Zed...).
> Người dùng Claude Code dùng bản [SKILL.md](SKILL.md) cùng thư mục (nội dung tương đương).
...
## Nguyên tắc tổng quát khi dùng bộ quy chuẩn này
...
- Nếu 1 dự án cụ thể có quy tắc riêng bổ sung ngoài bộ tổng quát này, quy tắc riêng đó thuộc về `memory-bank/11-coding-rules.md` của chính dự án đó, **không sửa vào bộ quy chuẩn này** — đây là quy chuẩn chung dùng chung cho mọi ứng dụng Xoăn.
